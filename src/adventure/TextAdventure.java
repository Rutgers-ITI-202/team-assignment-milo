...
public class TextAdventure {
	...
	public static void main(String[] args) {
		...
		AdventureModel item2 = new AdventureModel("Helpenol", false);
		AdventureModel item3 = new AdventureModel("Magic Banana Dildo", false);
		AdventureModel item4 = new AdventureModel("Key", false);
		AdventureModel item5 = new AdventureModel("Mystical Smoking Banana", true);
		AdventureModel item6 = new AdventureModel("Box of Krispy Kreme Donuts", true);
		AdventureModel item7 = new AdventureModel("Shield", false);
		AdventureModel item8 = new AdventureModel("Coconut Bombs", false);
		AdventureModel item9 = new AdventureModel("Car Keys", false);
		AdventureModel item10 = new AdventureModel("Laser Gun", false);
		AdventureModel item11 = new AdventureModel("Triplevil", false);
		AdventureModel item12 = new AdventureModel("Fire Stone", false);		
		...
		elderTreeForestItems.add(item7);
		elderTreeForestItems.add(item8);
		...
		gvsPharmacyItems.add(item2);
		gvsPharmacyItems.add(item11);
		...
		boolean inPlay = true;
		while(inPlay && Fuze.getNeededItems() < 7)
		{
			//Gets user input
			System.out.print("> ");
